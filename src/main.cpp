...
// Example: PGM_TPF_Playground.[exe/o] 3 5 0.1 1.0 1000 500 0.95 10 0.8 1.2 0 0
int main(int argc, char* argv[]) {
    auto const& options = pgm_tpf_playground::parse_experiment_options(argc, argv);
    auto const& dataset = pgm_tpf_playground::generate_fictional_grid(options);
    ...
    pgm_tpf_playground::TPF tpf{pgm_data, pgm_tpf_playground::frequency};
